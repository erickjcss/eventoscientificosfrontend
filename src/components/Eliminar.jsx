  ...
  const navigate=useNavigate(); 
    ...
    if(cont==0){
        ...
        for(let i=0;i<res.data.length;i++){
         ...
         if(ace){
            await axios.delete(`http://localhost:8000/personas/api/v1/personas/${res.data[i].id}/`)
           ...
           try {
            ...
            const eliminadoResponse = await axios.post(`http://localhost:8000/us/api/v1/eliminar/`,{
                'username':email,
                'password':password,
