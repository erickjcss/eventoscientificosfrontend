            ...
            console.log($docu)
                ...
                const  onSubmit=handleSubmit(async(data,e)=>{
                       ...
                       /*  if(newCont==0){
                                ...
                                if(habEdicion!=true){
                                  const res=await fetch("http://localhost:8000/pendientes/api/v1/pendientes/",{
                                    method:"POST",
                                    body:formData,
                                  ...
                                  /* alert("Usted ha subido una publicación, pero por problemas de seguridad primero pasara por un proceso de revisión, se le informará de la decisión tomada"); */
                                          ...
                                          formData.append("aprobada",false);
                                          const ress=await fetch("http://localhost:8000/publications/api/v1/publications/",{
                                    method:"POST",
                                    body:formData,
                                ...
                                return    
                                          ...
                                          const ressa=await fetch("http://localhost:8000/notifica/api/v1/notifica/",{
                                    method:"POST",
                                    body:formData2})
                                }
                                else{
                                  ...
                                  try {
                                    ...
                                    await axios.put(`http://localhost:8000/publications/api/v1/publications/${dire}/`, formData)
                                    setHabEdicion(false);
             ...
             setTimeout(() => {
               ...
               /* const Editarr=(async()=>{
                try {
                  ...
                  await axios.put(`http://localhost:8000/pendientes/api/v1/pendientes/${publicacionesP[numPubP].id}/`, {
